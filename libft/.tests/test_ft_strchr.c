...
/*   Updated: 2024/06/24 03:03:25 by dmytrokolid      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_ft_strchr()
{
       ...
       ft_printf("Test 1: ft_strchr(\"Hello World!\", 'o') - Result: %p, Expected: %p - %s\n",
       ...
       ft_printf("Test 2: ft_strchr(\"Hello World!\", 'x') - Result: %p, Expected: NULL - %s\n",
       ...
       ft_printf("Test 3: ft_strchr(\"x\", 'x') - Result: %p, Expected: %p - %s\n",
       ...
       ft_printf("Test 4: ft_strchr(\"Hello World!\", '\\0') - Result: %p, Expected: %p - %s\n",
