...
void test_ft_itoa()
{
    ...
    ft_printf("Test 1: ft_itoa(%d) - Result: %s - %s\n", num1, result1,
    ...
    ft_printf("Test 2: ft_itoa(%d) - Result: %s - %s\n", num2, result2,
    ...
    ft_printf("Test 3: ft_itoa(%d) - Result: %s - %s\n", num3, result3,
    ...
    ft_printf("Test 4: ft_itoa(%d) - Result: %s - %s\n", num4, result4,
    ...
    ft_printf("Test 5: ft_itoa(%d) - Result: %s - %s\n", num5, result5,
    ...
    ft_printf("Test 6: ft_itoa(%d) - Result: %s - %s\n", num6, result6,
