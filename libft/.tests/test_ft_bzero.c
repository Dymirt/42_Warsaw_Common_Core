...
void test_ft_bzero()
{
    ...
    ft_printf("Test 1: ft_bzero(\"Hello\", 1) - Result: %s, Expected: %s - %s\n",
    ...
    ft_printf("Test 2: ft_bzero(\"Test\", sizeof(buffer) - 1) - Result: %s, Expected: %s - %s\n",
    ...
    ft_printf("Test 3: ft_bzero(\"Love You\" + 3, 3) - Result: %s, Expected: %s - %s\n",
