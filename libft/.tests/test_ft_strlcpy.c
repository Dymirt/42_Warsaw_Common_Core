...
void test_ft_strlcpy()
{
       ...
       ft_printf("Test 1: ft_strlcpy(\"Hello\", \"World\", 10) - Result: %s, %zu, Expected: World, 5 - %s\n",
              dest1, result1,
       ...
       ft_printf("Test 2: ft_strlcpy(\"Hello\", \"\", 10) - Result: %s, %zu, Expected: \"\", 0 - %s\n",
              dest2, result2,
              result ? GREEN "PASS" NORMAL : RED "FAIL" NORMAL);
       ...
       ft_printf("Test 3: ft_strlcpy(\"Hello\", \"World\", 5) - Result: %s, %zu, Expected: Wor, 5 - %s\n",
              dest3, result3,
              result ? GREEN "PASS" NORMAL : RED "FAIL" NORMAL);
}
