...
void test_ft_calloc()
{
    ...
    ft_printf("Test 1: ft_calloc(5, sizeof(int)) - Result: %s\n",
    ...
    ft_printf("Test 2: ft_calloc(8, sizeof(char)) - Result: %s\n",
        result ? GREEN "Pass" NORMAL : RED "Fail" NORMAL);
    free(result2);
    free(expected2);
    ...
    ft_printf("Test 2: ft_calloc(3, sizeof(CustomStruct)) - Result: %s\n",
        result ? GREEN "Pass" NORMAL : RED "Fail" NORMAL);
    free(result3);
    free(expected3);
}
