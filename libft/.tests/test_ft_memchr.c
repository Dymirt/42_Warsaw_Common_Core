...
void test_ft_memchr()
{
    ...
    ft_printf("Test 1: ft_memchr(\"Hello\", 'e', 5) - Result: %s, Expected: %s - %s\n",
    ...
    ft_printf("Test 2: ft_memchr(\"Test\", 't', sizeof(\"Test\")) - Result: %s, Expected: %s - %s\n",
    ...
    ft_printf("Test 3: ft_memchr(\"Love You\" + 2, ' ', 5) - Result: %s, Expected: %s - %s\n",
    ...
    ft_printf("Test 4: ft_memchr(\"Love You\", 'x', sizeof(\"Love You\")) - Result: %s, Expected: %s - %s\n",
