...
void test_ft_strdup()
{
    ...
    ft_printf("Test 1: ft_strdup(\"Hello, World!\") - Result: %s, Expected: %s - %s\n", result1, expected1,
    ...
    ft_printf("Test 2: ft_strdup(\"\") - Result: %s, Expected: %s - %s\n", result2, expected2,
        result ? GREEN "Pass" NORMAL : RED "Fail" NORMAL);
    free(result2);
    free(expected2);
    ...
    ft_printf("Test 3: ft_strdup(\"   Spaces   \") - Result: %s, Expected: %s - %s\n",
    	result3, expected3,
        result ? GREEN "Pass" NORMAL : RED "Fail" NORMAL);
    free(result3);
    free(expected3);
    ...
    ft_printf("Test 4: ft_strdup(\"!@#\") - Result: %s, Expected: %s - %s\n", result4, str4,
        result ? GREEN "Pass" NORMAL : RED "Fail" NORMAL);
    free(result4);
}
