...
void test_ft_memcmp()
{
    ...
    ft_printf("Test 1: ft_memcmp(\"Hello\", \"Hello\", sizeof(\"Hello\")) - Result: %d, Expected: %d - %s\n",
    ...
    ft_printf("Test 2: ft_memcmp(\"Tested\", \"Test\", 4) - Result: %d, Expected: %d - %s\n",
    ...
    ft_printf("Test 3: ft_memcmp(\"\\0I Love You\", \"\\0I Don't Love You\", 6) - Result: %d, Expected: %d - %s\n",
    ...
    ft_printf("Test 4: ft_memcmp(\"Hall\", \"Hell\", 6) - Result: %d, Expected: %d - %s\n",
    ...
    ft_printf("Test 5: ft_memcmp(\"\\0I Love You\", \"\\0I Don't Love You\", 0) - Result: %d, Expected: %d - %s\n",
