...
void test_ft_putstr_fd()
{
    ...
    char *str2 = "\t~~~~!";
    ft_putstr_fd(str2, 1);
    ft_printf("Test 2: ft_putstr_fd('\\t~~~~!', 1): if this line starts with tab, stdout is working\n");
}
