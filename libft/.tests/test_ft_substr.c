...
void test_ft_substr()
{
       ...
       ft_printf("Test 1: ft_substr(\"Hello, World!\", 7, 5) - Result: %s, Expected: %s - %s\n",
              result1, expected1,
       ...
       ft_printf("Test 2: ft_substr(\"Testing\", 0, 20) - Result: %s, Expected: %s - %s\n",
              result2, expected2,
              result ? GREEN "PASS" NORMAL : RED "FAIL" NORMAL);
       ...
       ft_printf("Test 3: ft_substr(\"\", 0, 3) - Result: %s, Expected: %s - %s\n",
              result3, expected3,
              result ? GREEN "PASS" NORMAL : RED "FAIL" NORMAL);
       ...
       ft_printf("Test 4: ft_substr(\"Substring\", 5, 0) - Result: %s, Expected: %s - %s\n",
              result4, expected4,
              result ? GREEN "PASS" NORMAL : RED "FAIL" NORMAL);
       ...
       ft_printf("Test 5: ft_substr(\"Substring\", 20, 5) - Result: %s, Expected: %s - %s\n",
              result5, expected5,
              result ? GREEN "PASS" NORMAL : RED "FAIL" NORMAL);
